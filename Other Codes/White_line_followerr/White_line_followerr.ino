...
int l,r,o;                                   // initializing two variables l & r for storing inputs from Light sensors.
void setup()
{
  pinMode(5,OUTPUT);
  pinMode(10,OUTPUT);                     //10,11 for left motor
  pinMode(7,OUTPUT);
  pinMode(8,OUTPUT);                     //12,13 for right motor
  digitalWrite(7,HIGH);
    digitalWrite(8,LOW);
  pinMode(11,OUTPUT);
...
void loop()
{
  ...
  if(r==LOW && l==LOW && o==LOW)                  // If both left & right sensor are on black surface
  ...
  else if(r==LOW && l==LOW && o==HIGH)                  // If both left & right sensor are on black surface
  ...
  else if(l==HIGH && r==LOW && o==LOW)             // If left sensor is on white surface and right sensor is on black surface
  ...
  else if(l==HIGH && r==LOW && o==HIGH)             // If left sensor is on white surface and right sensor is on black surface
  {                                     // the left motor will go backward & right motor will go forward.
    digitalWrite(10,HIGH);
    digitalWrite(11,HIGH);
    digitalWrite(12,HIGH);
  ...
  else if(l==LOW && r==HIGH && o==LOW)            // If left sensor is on white and right sensor is on black surface
  {                                     // the left motor will go backward & right motor will go forward.
    digitalWrite(10,HIGH);
    digitalWrite(11,LOW);
    digitalWrite(12,LOW);
  ...
  else if(l==LOW && r==HIGH && o==HIGH)            // If left sensor is on white and right sensor is on black surface
  {                                     // the left motor will go backward & right motor will go forward.
    digitalWrite(10,HIGH);
    digitalWrite(11,HIGH);
    digitalWrite(12,HIGH);
